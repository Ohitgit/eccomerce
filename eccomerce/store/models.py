...
class Order(models.Model):
    ...
    pincode=models.CharField(max_length=100,null=True,blank=True ,db_index=True)
    house_no=models.CharField(max_length=100,null=True,blank=True ,db_index=True)
    road_no=models.CharField(max_length=100,null=True,blank=True ,db_index=True)
    landmark=models.CharField(max_length=100,null=True,blank=True ,db_index=True)
